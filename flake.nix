{
  ...
  in {
    ...
    packages.x86_64-linux.default = pythonSet.mkVirtualEnv "mergify" workspace.deps.default;
    ...
    devShells.x86_64-linux = {
      ...
      impure = pkgs.mkShell {
        ...
        shellHook = ''
          unset PYTHONPATH
          export VIRTUAL_ENV_NAME=mergify-impure
        '';
      };
      ...
      default = let
        ...
        virtualenv = editablePythonSet.mkVirtualEnv "mergify-dev" workspace.deps.all;
      in
        pkgs.mkShell {
          packages = [
            virtualenv
    ...
    # devShells.default = self.devShells.x86_64-linux.uv2nix;
  };
}
